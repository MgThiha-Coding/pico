...
import 'package:pico_pos/presentation/wrapper/view/mobile/mobile_ticket_entry_screen.dart';
                          ...
                          showDialog(
                            ...
                            builder: (context) {
                              return AlertDialog(
                                ...
                                content: Text(
                                  "Are you sure you want to remove ${data.name} from the cart?",
                                ),
                                actions: [
                                  TextButton(
                                    onPressed: () {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => MobileTicketEntryScreen(),
                      ),
                    );
                  },
